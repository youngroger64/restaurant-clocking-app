...
echo "Creating demo simulation command..."

mkdir -p core/management/commands
touch core/management/__init__.py
touch core/management/commands/__init__.py

cat > core/management/commands/load_demo_clock_events.py <<'PY'
...
echo "Demo command installed."
echo ""
echo "To load demo data:"
echo "python manage.py load_demo_clock_events --date 2026-06-15 --clear"
echo ""
echo "Then open:"
echo "/manager/today/?date=2026-06-15"
